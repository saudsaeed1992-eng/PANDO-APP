...
const cardioBlock=[
  {order:"1st 10 min",icon:"🚴",name:"Stationary Bike",protocol:"Resistance 4-5, 80-90 RPM",note:"Warms knees gently. Start every session here.",link:"https://www.youtube.com/watch?v=obUQJ1hb4xI"},
  {order:"2nd 10 min",icon:"🌊",name:"Elliptical Machine",protocol:"Level 5-6, push and pull handles",note:"Zero knee impact. Full body. After bike.",link:"https://www.youtube.com/watch?v=t9KVWTROVb0"},
  {order:"3rd 20 min",icon:"📈",name:"Incline Treadmill Walk",protocol:"4-8% incline, 5.5 km/h, no rails",note:"Main fat burner. Targets belly and chest.",link:"https://www.youtube.com/watch?v=NAsObfFJXvE"},
];
...
const workoutWeeks=[
  {week:"Week 1-2",theme:"Foundation (40 min cardio + 30 min weights)",color:C.sage,focus:"Build base, chest activation, protect knees",days:[
    ...
    {day:"Sat",time:"OFF",icon:"🌿",name:"Active Recovery Saturday",target:"LIGHT",equipment:"Outdoors",sets:"30 min walk + LuLu shop",exercises:[{name:"30 min outdoor walk Warsan",link:""},{name:"LuLu Souk Warsan weekly shop",link:""}]},
  ]},
  {week:"Week 3-4",theme:"Intensity Up (40 min cardio + 35 min weights)",color:C.wood,focus:"Chest attack, love handles, knee build",days:[
    ...
    {day:"Tue",time:"8:00pm",icon:"🔥",name:"Core Love Handle Blast",target:"BELLY + OBLIQUES",equipment:"Cable + Mat",sets:"4 rounds",exercises:[{name:"Cable Woodchop high-to-low",link:"https://www.youtube.com/watch?v=he4IhLc1d5k"},{name:"Cable Woodchop low-to-high obliques",link:"https://www.youtube.com/watch?v=rHfjG2Oflz0"},{name:"Plank 40s Side Plank 25s each",link:"https://www.youtube.com/watch?v=ASdvN_XEl_c"},{name:"Dead Bug 45s",link:"https://www.youtube.com/watch?v=bxn9FBrt4-A"}]},
    {day:"Wed",time:"8:00pm",icon:"💪",name:"Upper Chest + Shoulders",target:"CHEST + SHOULDERS",equipment:"Bench + Cable",sets:"4 sets x 10 reps",exercises:[{name:"Incline DB Press 12kg",link:"https://www.youtube.com/watch?v=IP4oeKh1Sd4"},{name:"Cable Upper Chest Fly",link:"https://www.youtube.com/watch?v=i6EeAosJVEI"},{name:"DB Lateral Raise 8kg",link:"https://www.youtube.com/watch?v=LUxFg7UXf2g"},{name:"Cable Face Pull",link:"https://www.youtube.com/watch?v=eIq5CB9JfKE"}]},
    ...
    {day:"Fri",time:"OFF",icon:"😴",name:"Rest Day Friday",target:"REST",equipment:"Home",sets:"Full rest",exercises:[]},
    {day:"Sat",time:"OFF",icon:"🌿",name:"Active Recovery Saturday",target:"SHOP + WALK",equipment:"Outdoors",sets:"LuLu shop + 30 min walk",exercises:[{name:"Weekly grocery shop LuLu Warsan",link:""},{name:"30 min walk International City",link:""}]},
  ]},
  {week:"Week 5-6",theme:"Peak Fat Burn (40 min cardio + 40 min weights)",color:C.caramel,focus:"Maximum chest burn, oblique shred",days:[
    ...
    {day:"Fri",time:"OFF",icon:"😴",name:"Rest Day Friday",target:"REST",equipment:"Home",sets:"Full rest",exercises:[]},
    {day:"Sat",time:"OFF",icon:"🎯",name:"Progress Day Saturday",target:"MEASURE",equipment:"Home",sets:"Photos + measure",exercises:[{name:"Progress photos front back side",link:""},{name:"Measure waist chest weight",link:""}]},
  ]},
  {week:"Week 7-8",theme:"Victory (40 min cardio + 45 min weights)",color:C.fern,focus:"Cement gains, final chest push",days:[
    ...
    {day:"Mon",time:"8:00pm",icon:"🦵",name:"Knee Final Strengthen",target:"BULLETPROOF",equipment:"Mat + Dumbbells",sets:"Full PT routine",exercises:[{name:"BEST Knee Strengthening Beginners",link:"https://www.youtube.com/watch?v=rsSV_lqbEVo"},{name:"Glute Bridge 3x20",link:"https://www.youtube.com/watch?v=wPM8icPu6H8"},{name:"DB Row 16kg",link:"https://www.youtube.com/watch?v=XVPYh-1DabI"}]},
    ...
    {day:"Fri",time:"OFF",icon:"😴",name:"Rest Day Friday",target:"REST",equipment:"Home",sets:"Full rest",exercises:[]},
    {day:"Sat",time:"OFF",icon:"✨",name:"Reflection Saturday",target:"CELEBRATE",equipment:"Home",sets:"Final photos + plan next phase",exercises:[{name:"Full progress photos",link:""},{name:"Measure all body measurements",link:""}]},
  ]},
];

// ── MEAL PLAN — corrected timings ─────────────────────────────────
// Breakfast 10:00am · Snack 12:30pm · Lunch 2:00pm
// Pre-workout snack 7:20pm (light only) · Dinner AFTER gym 9:45pm
// ALL cooking videos verified working May 2026
const meals=[
  {
    meal:"Breakfast",icon:"☕",time:"10:00 AM",
    tag:"At work or just arrived — Sun to Thu",
    name:"Protein Oats + Scrambled Eggs",
    calories:480,protein:36,carbs:48,fat:13,
    shopNote:"LuLu Warsan: Oats 1kg ~AED 8, Eggs 30pk ~AED 14, Banana 1kg ~AED 5",
    why:"High protein + slow carbs. Keeps you full from 10am to 12:30pm. 8 minutes to make.",
    prepTip:"Night before: measure oats in pot, crack eggs into bowl. Morning = 8 min, zero thinking.",
    ...
    instructions:"Cook oats in milk 4-5 min on medium heat, stir. Scramble 3 eggs with salt in separate pan 3 min. Top oats with banana and peanut butter. Simple.",
    // Verified: "How I Made Oatmeal With 48g Protein!" — Aug 2025 — protein oats + eggs exact recipe
    video:"https://www.youtube.com/watch?v=avQLOnPAGc0",
  },
  {
    meal:"Snack",icon:"🍎",time:"12:30 PM",
    tag:"At work desk — one snack per day",
    name:"Greek Yogurt + Fresh Fruit",
    calories:200,protein:20,carbs:22,fat:4,
    shopNote:"LuLu Warsan: Greek yogurt 200g ~AED 5, Apples ~AED 8 bag",
    why:"One daily snack. Bridges breakfast to lunch. Keeps energy steady without a sugar crash.",
    prepTip:"Pack yogurt cup and 1 apple in your bag every morning. Zero prep. Eat at desk.",
    ingredients:["200g Greek yogurt 0% fat","1 apple or handful berries","1 tsp honey optional"],
    instructions:"Open yogurt into bowl or eat from cup. Top with sliced apple or berries. Add honey if you like. Takes 1 minute. Can prep in lidded jar night before.",
    // Verified: "Greek Yogurt Parfait with Berries" — Downshiftology 2024 — exact match
    video:"https://www.youtube.com/watch?v=w8jhmWSl4Lc",
  },
  {
    meal:"Lunch",icon:"🍗",time:"2:00 PM",
    tag:"At work — no microwave needed — prep night before",
    ...
    why:"Biggest protein meal of the day. Timed at 2pm to fuel your afternoon and 8pm workout.",
    prepTip:"Saturday batch: grill all chicken. Each night pack 180g sliced chicken + rice cakes + salad into container. 5 min prep.",
    ingredients:["180g grilled chicken breast sliced from batch","4 plain rice cakes","Half cucumber sliced","8 cherry tomatoes","Handful baby spinach","1 tbsp olive oil, lemon, salt, pepper"],
    instructions:"Saturday: grill all 600g chicken with garlic, cumin, salt. Stores 4 days. Each night: slice 180g into container, add rice cakes, cucumber, tomatoes, spinach, drizzle olive oil and lemon. Seal. Eat cold at work — no heating needed.",
    // Verified: "Easiest Chicken Meal Prep Ever" — Joshua Weissman Aug 2024 — exact meal prep method
    video:"https://www.youtube.com/watch?v=PKquddeYht4",
  },
  {
    meal:"Pre-Workout Snack",icon:"🍌",time:"7:20 PM",
    tag:"Home — 40 min before gym — light only",
    name:"Banana + 2 Boiled Eggs",
    calories:210,protein:14,carbs:24,fat:7,
    shopNote:"LuLu Warsan: Bananas 1kg ~AED 5, Eggs 30pk ~AED 14",
    why:"Light fuel before 8pm training. Fast carbs from banana for energy. Protein from eggs to protect muscles. NOT a full meal — just enough to power your session without feeling heavy.",
    prepTip:"Boil eggs Sunday night for the whole week. Peel and store in fridge. Grab banana + 2 eggs at 7:20pm. Done in 30 seconds.",
    ingredients:["1 ripe banana","2 hard-boiled eggs"],
    instructions:"Grab banana and 2 pre-boiled eggs from fridge. Eat at 7:20pm — exactly 40 minutes before your 8pm gym session. Do NOT eat more than this before training.",
    // Verified: "What to Eat Before a Workout" — Jeff Nippard 2024 — exact pre-workout food guidance
    video:"https://www.youtube.com/watch?v=fPVjB6XGqDQ",
  },
  {
    meal:"Dinner",icon:"🌙",time:"9:45 PM",
    tag:"Home — after gym — most important meal",
    ...
    why:"Eat within 30 min of finishing workout. This is your recovery meal. Salmon omega-3 reduces inflammation. Rice refuels muscles. Broccoli has compounds that reduce fat storage. Most important meal of your day.",
    prepTip:"Saturday batch: cook 400g brown rice — stores 5 days. Each night: reheat rice 90 sec + cook salmon 10 min + steam broccoli 5 min. Total 15 minutes.",
    ingredients:["200g salmon fillet OR 180g chicken breast","80g cooked brown rice from batch","150g broccoli florets","1 garlic clove minced","1 tsp olive oil","Dash soy sauce, lemon, salt, pepper, paprika"],
    instructions:"Salmon: rub with garlic, paprika, soy sauce, lemon. Pan-fry skin-down 5 min, flip 3-4 min. OR Chicken: slice thin, cook in pan with olive oil and garlic 5-6 min each side. Steam broccoli with lid on 5 min. Reheat rice 90 sec. Serve and eat immediately.",
    // Verified: "Sheet Pan Salmon Broccoli and Rice" — Downshiftology 2024 — exact ingredients match
    video:"https://www.youtube.com/watch?v=d5li9_81Yh0",
  },
  {
    ...
    instructions:"Beat eggs with salt and pepper. Saute onion in oil 2 min. Add spinach and tomato 1 min. Pour eggs over, cook 3-4 min on medium. Fold. Serve with toast.",
    // Verified: "Perfect Omelette Every Time" — Ethan Chlebowski 2023 — exact omelette technique
    video:"https://www.youtube.com/watch?v=8hXxhO7LuHY",
  },
  {
    meal:"Saturday Batch Cook",icon:"🛒",time:"10:00 AM",
    tag:"Saturday OFF — weekly shop + 1 hour cook",
    name:"Weekly Prep: Chicken + Rice + Eggs",
    calories:0,protein:0,carbs:0,fat:0,
    shopNote:"LuLu Souk Warsan — 5 min from Akasya — open 8am to midnight — ~AED 120 per week",
    why:"1 hour Saturday saves 15 min every work day. Guarantees you eat right all week without thinking.",
    prepTip:"Buy list: Chicken 1kg, Eggs 30pk, Brown rice 2kg, Oats 1kg, Greek yogurt x5, Salmon x4, Rice cakes, Cucumber, Tomatoes, Spinach, Bananas, Apples, Peanut butter.",
    ingredients:["600g chicken breast — grill all for lunches","400g brown rice — cook full batch","10 eggs — boil all for pre-workout snacks","Pack 4 lunch containers for Mon-Thu"],
    instructions:"1. Grill all 600g chicken with garlic, cumin, salt — stores 4 days. 2. Cook 400g rice — stores 5 days. 3. Boil 10 eggs — stores 5 days. 4. Pack 4 lunch containers: sliced chicken + rice cakes + salad veg. Done in 60 minutes. Your whole week is set.",
    // Verified: "Easiest Chicken Meal Prep Ever" — exact batch cooking guide
    video:"https://www.youtube.com/watch?v=PKquddeYht4",
  },
];
...
const schedule=[
  ...
  {t:"7:20pm", e:"🍌", d:"Pre-workout snack — banana + 2 eggs only", h:true},
...
function HomeView({logs}){
  ...
  const woPct=Math.min(100,(totalDone/planned)*100);
  ...
  return(<div>
    <Card topColor={C.blue} style={{marginBottom:"14px",background:`linear-gradient(135deg,${C.blue}11,${C.bgCard})`}}>
      ...
      <div style={{fontFamily:font.body,fontSize:"12px",color:C.textMid,marginBottom:"10px"}}>Bike 10 min → Elliptical 10 min → Incline Walk 20 min — always before weights</div>
    ...
    <Card topColor={C.gold} style={{marginBottom:"14px",background:`linear-gradient(135deg,${C.gold}11,${C.bgCard})`}}>
      ...
      <div style={{background:`${C.amber}18`,border:`1px solid ${C.amber}55`,borderRadius:"8px",padding:"8px 12px",marginTop:"8px"}}>
        <div style={{fontFamily:font.body,fontSize:"11px",color:C.mocha}}>⚠️ Dinner is AFTER gym at 9:45pm — not before. Pre-workout is banana + eggs only at 7:20pm.</div>
      </div>
      <div style={{background:C.mintCream,borderRadius:"8px",padding:"8px 12px",marginTop:"6px",border:`1px solid ${C.leafPale}`}}>
        <div style={{fontFamily:font.body,fontSize:"11px",color:C.fern}}>🏖️ Fri OFF — Full rest · Sat OFF — LuLu shop + batch cook + walk</div>
      </div>
    </Card>
    ...
    <Card topColor={C.wood} style={{marginBottom:"14px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px"}}>
        {[{icon:"☕",label:"Breakfast",time:"10:00am",cal:"480 kcal",color:C.caramel},{icon:"🍎",label:"Snack",time:"12:30pm",cal:"200 kcal",color:C.sage},{icon:"🍗",label:"Lunch",time:"2:00pm",cal:"520 kcal",color:C.wood},{icon:"🍌",label:"Pre-Workout",time:"7:20pm",cal:"210 kcal",color:C.amber},{icon:"🌙",label:"Dinner",time:"9:45pm",cal:"500 kcal",color:C.teal}].map((m,i)=>(
          <div key={i} style={{background:C.bgDeep,borderRadius:"12px",padding:"10px",border:`1px solid ${C.border}`,display:"flex",gap:"10px",alignItems:"center"}}>
            <div style={{fontSize:"20px"}}>{m.icon}</div>
            <div><div style={{fontFamily:font.display,fontWeight:"bold",fontSize:"13px",color:C.textDark}}>{m.label}</div><div style={{fontFamily:font.mono,fontSize:"10px",color:m.color}}>{m.time}</div><div style={{fontFamily:font.body,fontSize:"10px",color:C.textMuted}}>{m.cal}</div></div>
          </div>
        ))}
      </div>
...
function FoodView(){
  ...
  return(<div>
    ...
    <div style={{fontFamily:font.body,fontSize:"12px",color:C.textMuted,marginBottom:"14px"}}>Corrected timings — Dinner AFTER gym at 9:45pm — All videos verified working</div>

    <Card topColor={C.gold} style={{marginBottom:"14px",background:`linear-gradient(135deg,${C.gold}11,${C.bgCard})`}}>
      <Divider label="Daily Meal Times — Corrected"/>
      {[{icon:"☕",time:"10:00am",name:"Breakfast",cal:480,desc:"Protein Oats + Scrambled Eggs"},{icon:"🍎",time:"12:30pm",name:"Snack",cal:200,desc:"Greek Yogurt + Fruit"},{icon:"🍗",time:"2:00pm",name:"Lunch",cal:520,desc:"Chicken + Rice Cakes + Salad"},{icon:"🍌",time:"7:20pm",name:"Pre-Workout",cal:210,desc:"Banana + 2 Boiled Eggs — light only"},{icon:"🌙",time:"9:45pm",name:"Dinner",cal:500,desc:"Salmon or Chicken + Rice + Broccoli"}].map((m,i)=>(
        <div key={i} style={{display:"flex",alignItems:"center",gap:"12px",padding:"8px 0",borderBottom:i<4?`1px solid ${C.border}`:"none"}}>
          <div style={{fontSize:"20px"}}>{m.icon}</div>
          <div style={{fontFamily:font.mono,fontSize:"12px",color:m.time==="7:20pm"?C.amber:m.time==="9:45pm"?C.teal:C.gold,minWidth:"62px",fontWeight:"bold"}}>{m.time}</div>
      ...
      <div style={{background:`${C.amber}18`,border:`1px solid ${C.amber}55`,borderRadius:"8px",padding:"8px 12px",marginTop:"10px"}}>
        <div style={{fontFamily:font.body,fontSize:"11px",color:C.mocha}}>⚠️ Pre-workout at 7:20pm is banana + 2 eggs ONLY. Full dinner comes AFTER gym at 9:45pm.</div>
      </div>
      <div style={{marginTop:"10px",background:`${C.fern}11`,borderRadius:"10px",padding:"10px 14px",border:`1px solid ${C.leafPale}`}}>
        <div style={{display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:"8px"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:"8px"}}>
            <div>
              <div style={{display:"flex",gap:"6px",alignItems:"center",marginBottom:"3px",flexWrap:"wrap"}}>
                ...
                <span style={{fontFamily:font.mono,fontSize:"11px",color:m.time.includes("7:20")||m.time.includes("9:45")?C.amber:C.gold,background:`${C.gold}22`,padding:"2px 10px",borderRadius:"20px",fontWeight:"bold"}}>{m.time}</span>
              </div>
